    ...
    return (
        <section className="w-full bg-gray-950  flex flex-col md:flex-row items-center justify-center py-16 px-4 overflow-hidden text-white">
            ...
            <div className="w-full md:w-1/2 flex flex-col items-center md:items-start z-10">
                ...
                <div className="text-[2.3rem] md:text-5xl font-extrabold uppercase tracking-wide mb-6 bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 via-cyan-400 to-violet-400">
                    SUPER CODYSSEY
                </div>
                <button
                    className="mt-2 px-7 py-3 rounded-md font-bold bg-white text-[#22235e] text-base shadow-xl hover:bg-cyan-100 transition"
                >
                    TRY 1 WEEK FREE
                </button>
            </div>
