...
const QUESTIONS = [
  ...
  },
  {
    ...
    icon: FiSmile,
    type: "text",
    question: "How would your friends describe you, in one line?",
    placeholder: "Loud in group chats, quiet in real life...",
  },
  {
    id: "hopingFor",
    icon: FiCompass,
    ...
    placeholder: "New ideas, your people, a place to vent...",
  },
];
  ...
  return (
    ...
    >
      <div className="flex items-start gap-4">
        ...
        <span
          aria-hidden="true"
          className={`mt-1.5 h-1.5 w-1.5 flex-shrink-0 rounded-full transition-colors duration-300 ${answered ? "bg-emerald-400/80" : "bg-white/10"
            }`}
        />
      </div>
    </div>
...
export default function PreferencesSetup({ onSubmit, onSkip }) {
